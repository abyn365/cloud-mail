...
export async function email(message, env, ctx) {
    ...
    try {
        ...
        const completeEmailRow = await emailService.completeReceive({ env }, account ? emailConst.status.RECEIVE : emailConst.status.NOONE, emailRow.emailId);
        // Preserve the original emailId as completeReceive might not return it properly in some D1 scenarios
        emailRow = { ...completeEmailRow, emailId: emailRow.emailId };
