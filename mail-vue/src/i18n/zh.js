const zh = {
    ...
    tgBotDesc: '可以将接收的邮件转发到 Telegram 机器人，支持用户/群组/超级群 chat_id',
    tgBotToken: '机器人 token',
    toBotTokenDesc: '输入目标 chat_id，多个用,分开',
    tgChatIdSupportDesc: '支持用户、群组、超级群 chat_id',
    tgChatIdExampleDesc: '示例：123456789,-1001234567890',
