const zh = {
    ...
    change: '修改',
    changePwdBtn: '修改密码',
    browserNotify: '浏览器/PWA 通知',
    browserNotifyDesc: '收到新邮件时通知我',
    browserNotifyUnsupported: '当前设备不支持浏览器通知',
    browserNotifyDenied: '通知权限被拒绝',
    username: '用户名',
    password: '密码',
    delAccount: '删除账户',
    ...
    template: '模板',
    recipients: '收件人',
    recipientPreview: '收件人预览',
    noRecipientsTip: '请上传收件人列表以查看预览',
    sendMerge: '开始群发',
    subjectPlaceholder: '你好 {{name}}',
    csvPlaceholder: 'email,name,order\nuser@example.com,张三,12345',
    csvUploadTip: 'CSV 必须包含表头。在主题或正文中使用 {{列名}} 进行替换。',
    uploadCSV: '上传 CSV',
    confirmSendMerge: '确定要向 {count} 位收件人发送个性化邮件吗？',
    partiallyFailed: '部分发送失败',
    failureDetails: '错误详情',
    close: '关闭',
