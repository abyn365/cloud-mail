const en = {
    ...
    change: 'Change',
    changePwdBtn: 'Change',
    browserNotify: 'Browser/PWA Notifications',
    browserNotifyDesc: 'Notify me when new email is received',
    browserNotifyUnsupported: 'Browser notifications are not supported on this device',
    browserNotifyDenied: 'Notification permission was denied',
    username: 'Username',
    password: 'Password',
